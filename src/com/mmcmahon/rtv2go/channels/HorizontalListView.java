...
public class HorizontalListView extends AdapterView<ListAdapter>
{
   ...
   protected static final String TAG = "#HorizontalListVIew#";
   ...
   private Runnable runReqLayout = new Runnable()
   {
      public void run()
      {
         requestLayout();
   ...
   private DataSetObserver mDataObserver = new DataSetObserver()
   {
      ...
      public void onChanged()
      {
         synchronized (HorizontalListView.this)
         {
            mDataChanged = true;
            // Log.e(TAG, "Changed");
            if (premiere && mAdapter != null)// searchWidth > 0)
            {
               HorizontalListView.this.mCurrentX = mAdapter.getView(0, null,
                     null).getWidth();
               premiere = false;
               // Log.e(TAG, "searchWidth " + mCurrentX);
            }
         }
         invalidate();
         requestLayout();
