    ...
    createEmbed: function(url){
        ...
        if(ID){
            data.embed =     
                ...
                Globals.width + "\" height=\"" + Globals.height + "\" src="+
                "\"http://www.youtube.com/embed/" + ID + "\"" +
                " frameborder=\"0\" /&gt;";
 
                /* 1/11/13 - Michael McMahon
                 * Older flash embed here. Spotty support for flash player on Android caused problems for that platform. Now uses html5 iframe.
            	 *  "&lt;object width=\"600\" height=\"338\"&gt;&lt;param name=\"movie\" value=\"http://www.youtube.com/v/"
